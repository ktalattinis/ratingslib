"""
Module for testing all unit-test of the apprate project
"""
...
from apprate.utils.logmsg import FILENAME, set_logger
from apprate.utils.methods import print_info, clean_args
...
set_logger(FILENAME)
TEST_MODULES = [
    "apprate.utils.tests.test_all",
    "apprate.ratings.tests.test_all",
    "apprate.app_sports.tests.test_all",
    "apprate.app_movies.tests.test_all"
]
