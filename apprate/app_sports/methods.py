...
import pandas as pd
import sklearn
from apprate.application import SportOutcome
from apprate.datasets.parse import parse_pairs_data
from apprate.datasets.preprocess import BasicPreprocess, Preprocess
from apprate.datasets.soccer import (DATE_COL, DAY_FIRST, WEEK_PERIOD)
from apprate.ratings.methods import (calc_items_stats, normalization_rating,
                                     rating_systems_to_dict)
from apprate.ratings.rating import RatingSystem

from apprate.utils.methods import (create_items_dict, get_indices,
                                   parse_columns, print_info, print_loading,
                                   print_pandas, str_info)
from apprate.utils.validation import (ValidationError, validate_from_set,
...
def predict_hindsight(data: pd.DataFrame,
    ...
    outcome : SportOutcome
        ...
        :class:`apprate.application.SoccerOutcome`.
        For more details see :mod:`apprate.application` module.

    pred_method : Literal['RANK', 'MLE'], default='RANK'
        Two available methods for predictions: 'RANK' or 'MLE'
        More details at :class:`apprate.application.SoccerOutcome`

    columns_dict : Optional[Dict[str, str]], default=None
        A dictionary mapping the column names of the dataset.
        See the module :mod:`apprate.datasets.parameters` for more details
...
class Predictions():
    ...
    pred_method : Union[Literal['MLE', 'RANK'], sklearn.base.BaseEstimator]
        ...
        More details for 'RANK' or 'MLE' at :class:`apprate.application.SoccerOutcome`
    ...
    columns_dict : Optional[Dict[str, Any], default=None
        ...
        See ``apprate.datasets.parameters.COLUMNS_DICT`` for more
        details.
...
def prepare_sport_dataset(data_season: pd.DataFrame,
    ...
    preprocess : Preprocess
        ...
        subclass of :class:`apprate.datasets.preprocess.Preprocess`
