...
class AccuRate(RatingSystem):
    """
    This class implements the :class:`apprate.ratings.RatingSystem` abstract
    ...
    version : str, default=ratings.ACCURATE
        ...
        versions can be found in :class:`apprate.utils.enums.ratings` class.
    ...
    >>> from apprate.datasets.filenames import dataset_path, FILENAME_ACCURATE_PAPER_EXAMPLE
    ...
    def computation_phase(self):
        ...
        :meth:`apprate.ratings.accurate.AccuRate.create_rating_vector` method
        """
