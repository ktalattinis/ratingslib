...
from apprate.datasets.filenames import (
    ...
    FILENAME_BOOK, FILENAME_BOOK_MOVIES, FILENAME_EPL_2018_2019_20_GAMES,
...
from apprate.datasets.soccer import COLUMNS_DICT, stats
from apprate.ratings.accurate import AccuRate
from apprate.ratings.aggregation import RatingAggregation
from apprate.ratings.colley import Colley
from apprate.ratings.elo import Elo
from apprate.ratings.keener import Keener
from apprate.ratings.markov import Markov
from apprate.ratings.massey import Massey
from apprate.ratings.methods import calc_items_stats
from apprate.ratings.od import OffenseDefense
from apprate.ratings.winloss import Winloss
from apprate.tests.test_all import printdetails
...
FP_FILENAME_BOOK, FP_FILENAME_EPL_2018_2019_20_GAMES, FP_FILENAME_GOVAN_THESIS,\
    ...
    FP_FILENAME_OOSA, FP_FILENAME_BOOK_MOVIES = datasets_paths(
        FILENAME_BOOK, FILENAME_EPL_2018_2019_20_GAMES,
        ...
        FILENAME_ACCURATE_PERFECT_SEASON, FILENAME_OOSA, FILENAME_BOOK_MOVIES)
...
class TestRatingSystems(unittest.TestCase):
    ...
    are based on the small running example of the book
    ...
    def test_colley(self):
        ...
        c = Colley().rate_from_file(FP_FILENAME_BOOK, sort=True)
    ...
    def test_massey(self):
        ...
        m = Massey().rate_from_file(FP_FILENAME_BOOK, sort=True)
    ...
    def test_winloss(self):
        ...
        w = Winloss(normalization=False).rate_from_file(FP_FILENAME_BOOK,
                                                        sort=True)
        assert_array_almost_equal(w.rating.values,
                                  np.array([4, 3, 2, 1, 0]),
                                  decimal=2)

        w = Winloss(normalization=True).rate_from_file(FP_FILENAME_BOOK,
                                                       sort=True)
        assert_array_almost_equal(w.rating.values,
    ...
    def test_offense_defense(self):
        ...
        mh = OffenseDefense(tol=0.0001).rate_from_file(FP_FILENAME_BOOK,
                                                       sort=True)
    ...
    def test_aggregation(self):
        ...
        massey = Massey().rate_from_file(FP_FILENAME_BOOK)
        colley = Colley().rate_from_file(FP_FILENAME_BOOK)
