...
from apprate.utils.methods import (create_items_dict,
                                   parse_columns)
from apprate.utils.validation import validate_not_none_and_type, validate_type
...
class RankingAggregation(RatingSystem):
    ...
    def computation_phase(self):
        ...
        :meth:`apprate.ratings.aggregations.RankingAggregation.ranking_aggregation` method.
        """
