...
from apprate.utils.methods import parse_columns, get_indices, \
    indices_and_points, create_items_dict
import numpy as np
import pandas as pd

from apprate.utils.validation import validate_from_set
...
class Elo(RatingSystem):
    ...
    def computation_phase(self):
        ...
        :meth:`apprate.ratings.elo.Elo.create_rating_vector` method"""
