...
from apprate.datasets.filenames import FILENAME_MOVIES_EXAMPLE
from apprate.datasets.parse import create_pairs_data
...
class TestPrepareData(unittest.TestCase):
    """
    A class to test functions from :mod:`apprate.app_movies.preparedata`
