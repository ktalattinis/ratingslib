"""
    ...
    #. `HS`, `AS`, `HST`, `AST` columns below are used in:
       :class:`apprate.ratings.markov.Markov`
       :class:`apprate.ratings.accurate.AccuRate`
"""
...
class stats:
    ...
    * STATISTIC COLUMNS DICTIONARY
    ...
    see the implementation of :func:`apprate.ratings.methods.calc_items_stats`
    ...
    * PARAMS DICTIONARY FOR MARKOV RATING SYSTEMS
    ...
    'LosersVotePointDiff'}
    for more information about the methods see :mod:`apprate.ratings.markov`
    module.
