...
from apprate.utils.logmsg import FILENAME, log

from apprate.utils.methods import get_filename, get_filenames, print_loading
from apprate.utils.validation import validate_type

# ==============================================================================
# Filenames path for datasets examples
# All paths have the parent directory apprate/datasets
# ==============================================================================
...
MOVIELENS_SMALL_PATH = MOVIES_PATH + "MovieLens/small/"


FILENAME_BOOK = EXAMPLES_PATH + "whos1-bookExample10games.csv"
FILENAME_BOOK_MOVIES = EXAMPLES_PATH + "whos1-bookExample-movies.csv"
...
FILENAME_ACCURATE_PERFECT_SEASON = EXAMPLES_PATH + "accuratePerfectSeason.csv"
