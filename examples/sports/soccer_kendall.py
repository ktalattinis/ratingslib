...
from apprate.ratings.metrics import kendall_tau_table
from apprate.utils.enums import ratings
from apprate.utils.methods import print_info, print_pandas
...
ratings_list = [
    ...
    ar.Markov(b=0.85, stats_markov_dict=stats_markov_dict),
    ar.AccuRate()
]
